...
class _FancyButtonState extends State<FancyButton> with TickerProviderStateMixin {
  ...
  double get buttonDepth => (widget.size ?? 0) * 0.2;
  ...
  void _setupAnimation() {
    ...
    _animationController = AnimationController(
      duration: Duration(microseconds: (widget.duration?.inMicroseconds ?? 0) ~/ 2),
      vsync: this,
  ...
  Widget build(BuildContext context) {
    final vertPadding = (widget.size ?? 0) * 0.25;
    final horzPadding = (widget.size ?? 0) * 0.50;
